package com.github.theredbrain.lootableblocks.network.packet;
...
public record UpdateInteractiveLootBlockPacket(
	...
	public static final Id<UpdateInteractiveLootBlockPacket> PACKET_ID = new Id<>(LootableBlocks.identifier("update_interactive_loot_block"));
